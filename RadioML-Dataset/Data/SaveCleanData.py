...
def SaveTrainData(Dataset, SavePath):
    ...
    np.save(SavePath + "/Clean_X_Train.npy", X_Train)
    np.save(SavePath + "/Clean_y_Train.npy", y_Train)
...
def SaveValidData(Dataset, SavePath):
	...
	f = open(SavePath + "/Clean_X_Valid.pkl","wb")
	pickle.dump(X_Valid,f)
	f.close()

	f = open(SavePath + "/Clean_y_Valid.pkl","wb")
...
SaveTrainData(TrainDataset, "Clean-Data")
SaveValidData(ValidDataset, "Clean-Data")
